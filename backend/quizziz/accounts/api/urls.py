...
urlpatterns = [
    ...
    path(
        ...
        include([
            ...
            path('quizzes/',
                 AccountQuizzesAPIView.as_view(),
                 name='account-quizzes'),
        ])),
    path(
        'current/',
        include([
            ...
            path('quizzes/',
                 CurrentAccountQuizzesAPIView.as_view(),
                 name='current-account-quizzes'),
            path(
                'update-settings/',
                include([
                    path('',
                         UpdateCurrentAccountSettingsAPIView.as_view(),
                         name='current-account-update-settings'),
                    path(
                        'password-reset/',
