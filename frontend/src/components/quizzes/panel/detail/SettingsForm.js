			...
			<form onSubmit={this.onSubmit}>
					...
					<div className="col col-md-6">
						...
						<div className="form-inline">
							...
							<div className="switch-btn" id="is_published">
								...
								/>
								<label htmlFor="is_published__true">
									Publish
								</label>
								...
								/>
								<label htmlFor="is_published__false">
									Private
								</label>
							</div>
						</div>
						...
						{errors.random_question_order ? (
							<div className="message-box error">
								{errors.random_question_order.map(
									(error, index) => (
										<p
											className="message-box__text"
											key={index}
						...
						<div className="form-inline">
							<label
								className="form-inline__label"
								htmlFor="random_question_order"
							>
								Radom question order:
							</label>
							<div
							...
							>
								...
								/>
								<label htmlFor="random_question_order__true">
									Yes
								</label>
								...
								/>
								<label htmlFor="random_question_order__false">
									No
								</label>
							</div>
						</div>
				...
				<div className="inline-btns f-w">
					<button
						type="reset"
						className={`btn ${
							!this.state.hasChanged ? 'btn__disabled' : ''
						}`}
						onClick={this.cancel}
					>
						Cancel
