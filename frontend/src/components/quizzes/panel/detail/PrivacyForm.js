					...
					<div className="col col-sm-6">
						...
						<div className="form-inline">
							...
							<small className="help-text">
								<span className="help-text__optional">
									OPTIONAL
								</span>
								To start solving your quiz, users will have to
								pass the password. Leave this field empty if you
								don't want require password.
							</small>
						</div>
					</div>
				</div>
