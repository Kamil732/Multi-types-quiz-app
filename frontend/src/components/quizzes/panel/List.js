			...
			<tr key={index}>
				...
				<td className="info">
					<Link
						...
						to={`/panel/dashboard/${quiz.slug}/summery`}
					>
						<TextTruncate
							text={quiz.title}
							line={3}
					...
					<div className="actions">
						...
						<button
							...
							onClick={() =>
								this.deleteQuiz(quiz.author_slug, quiz.slug)
							}
						>
							Delete
						</button>
				...
				<td className="numbers">
					...
					{quiz.solves_average ? (
						<>
							<h6>
								{quiz.solves_average} / {quiz.question_amount}
							</h6>
						</>
					) : null}
				</td>
				...
				<table className="table">
					<thead>
						<tr>
							...
							<th scope="col" style={{ padding: '0 150px' }}>
								Info
							</th>
